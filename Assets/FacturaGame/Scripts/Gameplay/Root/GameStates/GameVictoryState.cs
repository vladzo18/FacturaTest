...
namespace FacturaGame.Scripts.Gameplay.Root.GameStates
{
    public class GameVictoryState : IState
    {
        ...
        public GameVictoryState(BaseStateMachine gameStateMachine, GameplaySceneUI gameplaySceneUI, BaseStateMachine carStateMachine, SystemsStopService  systemsStopService)
        {
        ...
        public void OnEnter(StateTransitionScope transitionScope)
        {
            ...
            _gameplaySceneUI.ShowVictoryWindow();
